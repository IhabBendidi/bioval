...
setup(
  ...
  version = 'v0.1.1.5-alpha',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/IhabBendidi/bioval/archive/refs/tags/0.1.1.5-alpha.tar.gz',    # I explain this later on
